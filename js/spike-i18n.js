...
(() => {
  ...
  function buildSelector(){
    ...
    sel.addEventListener('change',async e=>{ active=e.target.value; localStorage.setItem(KEY,active); await boot(true); });
  }
  ...
  window.SPIKE_I18N={get language(){return active}, setLanguage:l=>{if(LANGS[l]){active=l;localStorage.setItem(KEY,l);return boot(true)}}, languages:LANGS};
})();