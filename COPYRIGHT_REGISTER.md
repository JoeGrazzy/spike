...
## 2.2 `assets/icon/logo.png`

**Status: LICENSED — Vecteezy Free License (provisional provenance; exact asset page not supplied).**

User-provided source: `https://www.vecteezy.com/free-png/logo` (Vecteezy logo PNG search page). Vecteezy states that free PNG downloads are available under its Free License and that the Free License requires attribution. The current Vecteezy License Agreement also permits digital use under the Free License, subject to its restrictions.

**Important logo-use limitation:** Vecteezy's current agreement does not grant exclusive ownership or trademark rights. Vecteezy's support guidance says images are not legally covered for logo/trademark use unless an appropriate exclusive license is obtained. Therefore this asset should **not** be treated as an exclusive SPIKE trademark/logo clearance merely because it was downloaded from the free PNG library.

**Required evidence:** retain the exact individual Vecteezy asset page, creator name, download date, license indication, and attribution text supplied at download. If `logo.png` is intended to be SPIKE's trademark/brand mark, replace it with original artwork or obtain a suitable exclusive/brand-clearance arrangement.

**SHA-256:** `444781d98eaa8ed40b7bf72454661bd02d5d9d61e6c9a73a0ed2e90e02d15303`

## 2.3 `assets/icon/icon.png`

**Status: LICENSED — Vecteezy Free License (provisional provenance; exact asset page not supplied).**

User-provided source: `https://www.vecteezy.com/free-png/logo` (Vecteezy logo PNG search page). The same Free License and logo/trademark limitations described for `logo.png` apply.
...
**SPIKE action:** keep a Font Awesome notice in `THIRD_PARTY_NOTICES.txt`; do not strip upstream license/attribution comments if Font Awesome assets are ever bundled locally.
...
1. `assets/icon/logo.png` — Vecteezy source identified; retain exact asset-page/license evidence and do not treat as exclusive trademark-cleared artwork.
...
10. Add this register and `THIRD_PARTY_NOTICES.txt` to the repository.
